...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-S5OEXHRQ.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-TPGQTRMW.js").then((mod) => ({
          default: mod.App
        })),
...
//# sourceMappingURL=chunk-V6YCFSEC.js.map
